...
const exportToExcel = (db) => {
    ...
    for(const type of config.dealers.vehicleTypesToExport){
        ...
        sheets[type].columns = [
            ...
            { header: 'Store Name', key: 'storename0', width: 20 },
            { header: 'Store Email', key: 'email0', width: 32 },
            { header: 'Store Name', key: 'storename1', width: 20 },
            { header: 'Store Email', key: 'email1', width: 32 },
            { header: 'Store Name', key: 'storename2', width: 20 },
            { header: 'Store Email', key: 'email2', width: 32 },
            { header: 'Store Name', key: 'storename3', width: 20 },
            { header: 'Store Email', key: 'email3', width: 32 },
            { header: 'Store Name', key: 'storename4', width: 20 },
            { header: 'Store Email', key: 'email4', width: 32 },
            { header: 'Store Name', key: 'storename5', width: 20 },
            { header: 'Store Email', key: 'email5', width: 32 },
            { header: 'Store Name', key: 'storename6', width: 20 },
            { header: 'Store Email', key: 'email6', width: 32 },
            { header: 'Store Name', key: 'storename7', width: 20 },
            { header: 'Store Email', key: 'email7', width: 32 },
            { header: 'Store Name', key: 'storename8', width: 20 },
            { header: 'Store Email', key: 'email8', width: 32 },
            { header: 'Store Name', key: 'storename9', width: 20 },
            { header: 'Store Email', key: 'email9', width: 32 },
            { header: 'Store Name', key: 'storename11', width: 20 },
            { header: 'Store Email', key: 'email11', width: 32 },
            { header: 'Store Name', key: 'storename10', width: 20 },
            { header: 'Store Email', key: 'email10', width: 32 },
            { header: 'Store Name', key: 'storename12', width: 20 },
